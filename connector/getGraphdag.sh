...
LINKS_RESPONSE=$(curl -s "https://ascii-chess-connector-3fac027ebe4d.herokuapp.com/links/?fen_string=rnbqkbnr%2Fpppppppp%2F8%2F8%2F8%2F8%2FPPPPPPPP%2FRNBQKBNR%20w%20KQkq%20-%200%201")
...
echo "$EDGES" | curl -X PUT "https://ascii-chess-connector-3fac027ebe4d.herokuapp.com/graphdag" \
