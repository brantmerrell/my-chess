...
export const getPieceDisplay = (
    ...
    switch (displayMode) {
        case "symbols":
            return PIECE_TO_FILLED_SYMBOL[piece] || PIECE_SYMBOLS[piece as keyof typeof PIECE_SYMBOLS] || piece;
        case "masked":
            return "*";
        case "letters":
        default:
...
export const getPieceColor = (piece: string, colorOverride?: string): "white" | "black" => {
    if (colorOverride) {
