...
export const CHESS_SETUPS = [
  new StaticPositionSetup('standard', 'Standard Starting Position', STANDARD_FEN),
  new DailyPuzzleSetup('lichess-daily-puzzle', 'Daily Lichess Puzzle', fetchLiChessDailyPuzzle),
  new DailyPuzzleSetup('chess-com-daily-puzzle', 'Daily Chess.com Puzzle', fetchChessComDailyPuzzle),
  // King Box Demos
  new StaticPositionSetup('king-vs-king', 'King vs King', 'rnbq1bnr/pppppppp/5k2/8/5K2/8/PPPPPPPP/RNBQ1BNR w KQkq - 0 1', 'King Box Demos'),
  new StaticPositionSetup('fools-mate', "Fool's Mate", 'rnb1kbnr/pppp1ppp/4p3/8/6Pq/5P2/PPPPP2P/RNBQKBNR w KQkq - 1 3', 'King Box Demos'),
  new StaticPositionSetup('embedded-mate', 'Embedded Mate', 'rnb4N/ppppk1pQ/8/2b5/2B5/8/PPP2nPP/RN4RK w - - 1 14', 'King Box Demos'),
  new StaticPositionSetup('open-board-mate', 'Open Board Mate', '8/b7/4b3/6kp/3qBQ2/5K2/8/8 b - - 1 6', 'King Box Demos'),
];
