...
const UnifiedChessContainer: React.FC<UnifiedChessContainerProps> = ({
    ...
    const [showFenControls, setShowFenControls] =
        React.useState<boolean>(false);
    const [showViewControls, setShowViewControls] =
        React.useState<boolean>(false);
    const [showMoveControls, setShowMoveControls] =
    ...
    const [moveDropdownValue, setMoveDropdownValue] =
        ...
        if (gameState.isPlaying && gameState.gameId) {
            ...
            sendMove(
                ...
                .catch((error) => {
                    ...
                    showNotification(
                        `Error sending ${uciMove} to Lichess`,
                        "error"
                    );
                });
        } else {
    ...
    const handleMoveAttempt = (
        ...
        try {
            ...
            if (matchingMoves.length === 0) {
                console.log(
                    "No legal moves found for this piece to that square"
                );
            ...
            if (
                ...
                matchingMoves.some((m) => m.promotion)
            ) {
            ...
            switch (e.key) {
                ...
                case "u":
                    ...
                    if (
                        ...
                        showNotification(
                            "Must be at latest position to undo",
                            "warning"
                        );
                    }
                    break;
    ...
    return (
        <div className="chess-container">
            ...
            <PromotionDialog
                ...
                color={
                    chessGameState.fen.split(" ")[1] === "w" ? "black" : "white"
                }
            />
        </div>
    );
